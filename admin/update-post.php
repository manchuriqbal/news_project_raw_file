  ...
  <div class="row">
    ...
    <div class="col-md-offset-3 col-md-6">
        ...
        <?php 
            ...
            $query = "SELECT post.post_id, post.post_title, post.post_desc,post.category, post.post_img, 
        ...
        <form action="save-update-post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <textarea name="post_desc" class="form-control"  required rows="5"><?php echo $row['post_desc']?>
                </textarea>
            </div>
            <div class="form-group">
            <label for="exampleInputPassword1">Category</label>
                <select name="category" class="form-control">
                    ...
                    $result1 = mysqli_query($connection, $query1) or die('category query failed!');
